...
CREATE TABLE `sp_ventas_detail` (
  ...
  `description_aditional1` text COLLATE utf8mb4_spanish_ci NOT NULL,
  `description_aditional2` text COLLATE utf8mb4_spanish_ci NOT NULL,
  `description_aditional3` text COLLATE utf8mb4_spanish_ci NOT NULL,
